...
\begin{figure}[H]
  \centering
  \subfloat[42 / 33 / 23]{\label{fig:gull111}\includegraphics[width=0.26\textwidth]{files/postmethod/img/eval_1-1.png}}        
  \hspace{0.1cm}
  \subfloat[54 / 23 / 11]{\label{fig:tiger111}\includegraphics[width=0.26\textwidth]{files/postmethod/img/eval_1-2.png}}
  \hspace{0.1cm}
  \subfloat[38 / 25 / 27]{\label{fig:mouse111}\includegraphics[width=0.26\textwidth]{files/postmethod/img/eval_1-3.png}}\\
  \subfloat[49 / 22 / 16]{\label{fig:gull222}\includegraphics[width=0.26\textwidth]{files/postmethod/img/eval_1-4.png}}        
  \hspace{0.1cm}
  \subfloat[60 / 25 / 5]{\label{fig:tiger222}\includegraphics[width=0.26\textwidth]{files/postmethod/img/eval_1-5.png}}
  \hspace{0.1cm}
  \subfloat[46 / 16 / 19]{\label{fig:mouse222}\includegraphics[width=0.26\textwidth]{files/postmethod/img/eval_1-6.png}}\\
  \subfloat[65 / 53 / 0]{\label{fig:gull333}\includegraphics[width=0.26\textwidth]{files/postmethod/img/eval_1_245comb.png}}
...
\begin{figure}[H]
  ...
  \subfloat[28 / 18 / 0]{\label{fig:gull99}\includegraphics[width=0.26\textwidth]{files/postmethod/img/eval_2_56comb.png}}
